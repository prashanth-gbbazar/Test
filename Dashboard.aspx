...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <label id="lblopen" class="lblfont1" runat="server" style="color: red">0</label>-<label class="lblfont1" id="lbldigit" runat="server" style="color: red">0</label>-<label class="lblfont1" id="lblclose" runat="server" style="color: red">0</label>
            &nbsp; | &nbsp; 
    ...
    <br />
    <div class="row">
        <div id="divmsg" runat="server" style="background-color:lightgreen;display:none;" class="col-md-4">Points Are Added To Wallet
        </div>
