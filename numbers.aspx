<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="numbers.aspx.cs" Inherits="numbers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-1">
            <label>Close</label>
            <asp:TextBox ID="tclose" runat="server" class="form-control" placeholder="XXX" MaxLength="3" />
             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="tclose"
                ValidationExpression="[0-9]{3}" ForeColor="#FF3300" Text="3-digits"></asp:RegularExpressionValidator>
        </div>
        <div class="col-md-2">
            <label>Game</label>
        ...
        <div class="table-responsive">
             <asp:GridView ID="gvsprovider" runat="server" CssClass="table table-bordered table-hover table-striped" OnPageIndexChanging="gvsprovider_PageIndexChanging" OnRowCommand="gvsprovider_RowCommand" AllowPaging="True" PageSize="10" Caption="Numbers" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="closenumber" HeaderText="Close"></asp:BoundField>
