<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Starline_Games.aspx.cs" Inherits="Starline" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="lblid" runat="server" Visible="false"></asp:Label>
    <h3><b>Starline Game Details</b></h3>
    <br />
    <div class="row">
        <div class="col-md-8">
            <div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvsprovider" runat="server" CssClass="table table-bordered table-hover table-striped" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="starlinegamesDS">
                    <Columns>
                ...
                <asp:SqlDataSource ID="starlinegamesDS" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:goldenbazarConnectionString4 %>" DeleteCommand="DELETE FROM [starline_maingames] WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([opentime] = @original_opentime) OR ([opentime] IS NULL AND @original_opentime IS NULL)) AND (([closetime] = @original_closetime) OR ([closetime] IS NULL AND @original_closetime IS NULL)) AND (([gameid] = @original_gameid) OR ([gameid] IS NULL AND @original_gameid IS NULL)) AND (([days] = @original_days) OR ([days] IS NULL AND @original_days IS NULL))" InsertCommand="INSERT INTO [starline_maingames] ([name], [opentime], [closetime], [gameid], [days]) VALUES (@name, @opentime, @closetime, @gameid, @days)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [starline_maingames] ORDER BY [id]" UpdateCommand="UPDATE [starline_maingames] SET [name] = @name, [opentime] = @opentime, [closetime] = @closetime, [gameid] = @gameid, [days] = @days WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([opentime] = @original_opentime) OR ([opentime] IS NULL AND @original_opentime IS NULL)) AND (([closetime] = @original_closetime) OR ([closetime] IS NULL AND @original_closetime IS NULL)) AND (([gameid] = @original_gameid) OR ([gameid] IS NULL AND @original_gameid IS NULL)) AND (([days] = @original_days) OR ([days] IS NULL AND @original_days IS NULL))">
                    <DeleteParameters>
        ...
        <div class="col-md-4">
            ...
            <br />
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover table-striped" Caption="Starline Plays" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="starlineplaysDS">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
                        <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                        <asp:BoundField DataField="name" HeaderText="name" SortExpression="name" />
                ...
                <asp:SqlDataSource ID="starlineplaysDS" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:goldenbazarConnectionString5 %>" DeleteCommand="DELETE FROM [starline_plays] WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([awardpoints] = @original_awardpoints) OR ([awardpoints] IS NULL AND @original_awardpoints IS NULL)) AND (([playid] = @original_playid) OR ([playid] IS NULL AND @original_playid IS NULL)) AND (([playids] = @original_playids) OR ([playids] IS NULL AND @original_playids IS NULL))" InsertCommand="INSERT INTO [starline_plays] ([name], [awardpoints], [playid], [playids]) VALUES (@name, @awardpoints, @playid, @playids)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [starline_plays] ORDER BY [id]" UpdateCommand="UPDATE [starline_plays] SET [name] = @name, [awardpoints] = @awardpoints, [playid] = @playid, [playids] = @playids WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([awardpoints] = @original_awardpoints) OR ([awardpoints] IS NULL AND @original_awardpoints IS NULL)) AND (([playid] = @original_playid) OR ([playid] IS NULL AND @original_playid IS NULL)) AND (([playids] = @original_playids) OR ([playids] IS NULL AND @original_playids IS NULL))">
                    <DeleteParameters>
                        <asp:Parameter Name="original_id" Type="Int64" />
                        <asp:Parameter Name="original_name" Type="String" />
